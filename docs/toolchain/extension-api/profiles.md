...
- [Stream profiles](#stream-profiles)
	...
	- [Stream-contract examples](#stream-contract-examples)
...
metadata codecs because a regular-file source or materializer makes additional
filesystem promises.
...
ordinary Extension using the same registry boundary as third-party profiles.
