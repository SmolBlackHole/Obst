...
| `PluginLoadError`                 | A selected trusted extension entry point cannot import, violates the factory contract or cannot compose with the selected registry.                                                    |
...
| `ConformanceError`                | A portable Stage conformance case or local provider result violates the conformance contract.                                                                                          |
